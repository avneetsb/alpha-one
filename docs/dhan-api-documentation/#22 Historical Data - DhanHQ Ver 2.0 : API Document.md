[Skip to content](https://dhanhq.co/docs/v2/historical-data/#historical-data)
...
- [Daily Historical Data](https://dhanhq.co/docs/v2/historical-data/#daily-historical-data)
- [Intraday Historical Data](https://dhanhq.co/docs/v2/historical-data/#intraday-historical-data)
...
| expiryCode<br> <br>_optional_ | enum integer | Expiry of the instruments in case of derivatives. Refer [here](https://dhanhq.co/docs/v2/instruments/) |
| oi<br>_optional_ | boolean | Open Interest data for Futures & Options |
...
| oi<br>_optional_ | boolean | Open Interest data for Futures & Options |
| fromDate<br>_required_ | string | Start date of the desired range |
| toDate<br>_required_ | string | End date of the desired range |
