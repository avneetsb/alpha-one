[Skip to content](https://dhanhq.co/docs/v2/order-update/#live-order-update)
...
- [Establishing Connection](https://dhanhq.co/docs/v2/order-update/#establishing-connection)

- [For Individual](https://dhanhq.co/docs/v2/order-update/#for-individual)
- [For Partners](https://dhanhq.co/docs/v2/order-update/#for-partners)

- [Order Update](https://dhanhq.co/docs/v2/order-update/#order-update)
...
| OrderType | enum string | Order Type<br>`LMT` for Limit<br>` MKT` for Market<br>` SL` for Stop Loss<br>` SLM` for Stop Loss |
